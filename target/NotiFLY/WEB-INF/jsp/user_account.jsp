...
<body>
	...
	<form:form modelAttribute = "user" method = "POST" action = "update">
		...
		<form:form method = "POST" action = "applications/update" modelAttribute = "user">
		<table id = "applications">
			...
			<c:forEach items = "${applications}" var = "a">
				<tr>
					...
					<td><input name = "application" value = "${a.key}"/></td>
		...
		<form:form modelAttribute = "user" method = "POST" action = "categories/update">
		<table id = "categories">
			<tr>
				<th></th>
				<th>Category</th>
			...
			<c:forEach items = "${categories}" var = "c">
				<tr>
					...
					<td><input name = "category" value = "${c.key}"/></td>
